-- Script final para corregir políticas RLS de bruno_invoices
...
DROP POLICY IF EXISTS "Users can insert invoices" ON public.bruno_invoices;
DROP POLICY IF EXISTS "Users can update invoices" ON public.bruno_invoices;
...
INSERT INTO public.bruno_invoices (
    ...
    'TEST_FINAL_001',
    'Proveedor de Prueba Final',
    '2025-01-01',
    1500.00,
    'paid',
    'Factura de prueba después de corrección final RLS',
    false
...
WHERE invoice_number = 'TEST_FINAL_001';

-- 8. Probar actualización
UPDATE public.bruno_invoices
SET total = 2000.00,
    description = 'Factura actualizada después de corrección final RLS'
WHERE invoice_number = 'TEST_FINAL_001';
...
DELETE FROM public.bruno_invoices WHERE invoice_number = 'TEST_FINAL_001';
