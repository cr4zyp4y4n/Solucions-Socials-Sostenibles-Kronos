-- Script para crear la tabla final de subvenciones
-- Basado en el análisis completo del CSV
...
CREATE TABLE public.subvenciones (
    ...
    saldo_pendiente_texto TEXT, -- Para texto descriptivo como "PEND. GESTIONAR"
