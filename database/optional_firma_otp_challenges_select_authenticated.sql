...
-- y en la consola de Kronos ves: [firma] firma_otp_primera_solicitud: permission denied
-- (o 0 filas al listar el historial OTP).
--
...
-- de 6 dígitos. Esta RPC expone únicamente el primer created_at por documento.
...
revoke select on public.firma_otp_challenges from anon, authenticated;
