-- Actualización de la función de eliminación en cascada para incluir todas las notificaciones
-- Ejecutar este archivo para corregir el error de eliminación de usuarios con notificaciones
...
BEGIN
    ...
    -- 2. Eliminar notificaciones donde el usuario es sender O recipient
...
SELECT 'Función complete_delete_user_cascade actualizada correctamente (incluye todas las notificaciones)' as status; 