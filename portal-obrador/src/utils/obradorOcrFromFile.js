...
/** Text natiu del PDF (sense OCR) — conserva salts de línia per al parser. */
...
/**
 * OCR o extracció de text des d'imatge o PDF (fins a 3 pàgines).
 * Retorna text pla (string).
 */
...
export async function pdfFirstPagePreviewUrl(file) {
